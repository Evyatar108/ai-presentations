...
/**
 * Chapter 6, Slide 2 - Unified Flow Details
 */
  ...
  return (
    <SlideContainer maxWidth={900}>
      ...
      <motion.div
        ...
        style={{ ...layouts.flexRow('0.5rem'), flexWrap: 'wrap' }}
      >
        {['Segment', 'Narrate', 'Extract', 'Rank', 'Compose'].map((step, idx) => (
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            transition={{ delay: reduced ? 0 : 0.3 + idx * 0.1 }}
            style={{
              ...gradientBox,
              borderRadius: 8,
      ...
      <motion.p
        ...
        style={{ ...typography.caption, textAlign: 'center', marginTop: '2rem', fontSize: 16 }}
      >
