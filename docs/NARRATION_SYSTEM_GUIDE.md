...
- If you add, move, or rename markers, re-run `npm run tts:align` to update alignment timestamps (or use the staleness panel's **Fix All** button in the browser, which runs batch TTS generation + full-demo alignment automatically)
