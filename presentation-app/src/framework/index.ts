...
export type { ShikiCodeBlockProps, ShikiColorTheme } from './components/ShikiCodeBlock';
...
export type { DemoMetadata, DemoConfig, DemoRegistryEntry, DurationInfo, DemoDefaultMode } from './demos/types';
