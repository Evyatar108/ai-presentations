...
export const metadata: DemoMetadata = {
  ...
  durationInfo: {
    ...
    slideBreakdown: [
      ...
      { slideIndex: 1, slideTitle: '22 Tools, 3 Skills, 1 Agent', chapterIndex: 1, totalDuration: 66.16, audioDuration: 60.16, delaysDuration: 6, segments: [{ segmentIndex: 0, audioDuration: 9.36, delayAfter: 1.5 }, { segmentIndex: 1, audioDuration: 38.16, delayAfter: 1.5 }, { segmentIndex: 2, audioDuration: 12.64, delayAfter: 3 }] },
