...
const INSTALL_CMD = `/plugin install devui@ai-developer-toolkit --scope user`;
    ...
    <SlideContainer maxWidth={850}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '0.75rem' }}>
        ...
        <Reveal from={1} animation={fadeUp}>
          <StepHeader number={2} title="Install the plugin" isActive={currentSegmentIndex === 1} />
          <div style={{
            fontSize: 13,
            color: theme.colors.textSecondary,
            marginBottom: 8,
            ...
            All 22 tools and 3 guided skills, directly in your conversation.
          </div>
          <div style={{ paddingLeft: 38 }}>
            <ShikiCodeBlock
              code={INSTALL_CMD}
