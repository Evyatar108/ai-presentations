...
export const metadata: DemoMetadata = {
  ...
  durationInfo: {
    ...
    slideBreakdown: [
      ...
      { slideIndex: 2, slideTitle: 'Verbose JSON', chapterIndex: 3, totalDuration: 20.86, audioDuration: 17.36, delaysDuration: 3.5, segments: [{ segmentIndex: 0, audioDuration: 14.88, delayAfter: 1.5 }, { segmentIndex: 1, audioDuration: 2.48, delayAfter: 2 }] },
      ...
      { slideIndex: 3, slideTitle: 'O(n^2) Visualized', chapterIndex: 4, totalDuration: 41.08, audioDuration: 36.08, delaysDuration: 5, segments: [{ segmentIndex: 0, audioDuration: 5.12, delayAfter: 1.5 }, { segmentIndex: 1, audioDuration: 15.44, delayAfter: 1.5 }, { segmentIndex: 2, audioDuration: 15.52, delayAfter: 2 }] },
