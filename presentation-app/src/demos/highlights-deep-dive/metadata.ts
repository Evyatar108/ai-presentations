...
export const metadata: DemoMetadata = {
  ...
  durationInfo: {
    ...
    slideBreakdown: [
      ...
      { slideIndex: 3, slideTitle: 'O(n^2) Visualized', chapterIndex: 4, totalDuration: 56.82, audioDuration: 50.32, delaysDuration: 6.5, segments: [{ segmentIndex: 0, audioDuration: 5.12, delayAfter: 1.5 }, { segmentIndex: 1, audioDuration: 15.44, delayAfter: 1.5 }, { segmentIndex: 2, audioDuration: 29.76, delayAfter: 3.5 }] },
      ...
      { slideIndex: 1, slideTitle: 'Format Comparison', chapterIndex: 5, totalDuration: 38.98, audioDuration: 32.48, delaysDuration: 6.5, segments: [{ segmentIndex: 0, audioDuration: 6.96, delayAfter: 1.5 }, { segmentIndex: 1, audioDuration: 13.44, delayAfter: 1.5 }, { segmentIndex: 2, audioDuration: 12.08, delayAfter: 3.5 }] },
      ...
      { slideIndex: 1, slideTitle: 'Prompt Overview', chapterIndex: 6, totalDuration: 76.58, audioDuration: 70.08, delaysDuration: 6.5, segments: [{ segmentIndex: 0, audioDuration: 12.88, delayAfter: 1.5 }, { segmentIndex: 1, audioDuration: 39.2, delayAfter: 1.5 }, { segmentIndex: 2, audioDuration: 18, delayAfter: 3.5 }] },
      { slideIndex: 2, slideTitle: 'Pseudocode Algorithm', chapterIndex: 6, totalDuration: 48.74, audioDuration: 42.24, delaysDuration: 6.5, segments: [{ segmentIndex: 0, audioDuration: 17.2, delayAfter: 1.5 }, { segmentIndex: 1, audioDuration: 16.24, delayAfter: 1.5 }, { segmentIndex: 2, audioDuration: 8.8, delayAfter: 3.5 }] },
      ...
      { slideIndex: 1, slideTitle: 'Validation Challenges', chapterIndex: 8, totalDuration: 76.02, audioDuration: 69.52, delaysDuration: 6.5, segments: [{ segmentIndex: 0, audioDuration: 10.24, delayAfter: 1.5 }, { segmentIndex: 1, audioDuration: 29.84, delayAfter: 1.5 }, { segmentIndex: 2, audioDuration: 29.44, delayAfter: 3.5 }] },
      { slideIndex: 2, slideTitle: 'Eval Tool', chapterIndex: 8, totalDuration: 69.62, audioDuration: 63.12, delaysDuration: 6.5, segments: [{ segmentIndex: 0, audioDuration: 8.24, delayAfter: 1.5 }, { segmentIndex: 1, audioDuration: 25.6, delayAfter: 1.5 }, { segmentIndex: 2, audioDuration: 29.28, delayAfter: 3.5 }] },
      ...
      { slideIndex: 2, slideTitle: 'Quality and Impact', chapterIndex: 9, totalDuration: 29.7, audioDuration: 23.2, delaysDuration: 6.5, segments: [{ segmentIndex: 0, audioDuration: 9.44, delayAfter: 1.5 }, { segmentIndex: 1, audioDuration: 8.08, delayAfter: 1.5 }, { segmentIndex: 2, audioDuration: 5.68, delayAfter: 3.5 }] },
