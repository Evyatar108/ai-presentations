...
Subtitle corrections: `public/audio/{demo-id}/subtitle-corrections.json` — maps TTS pronunciation spellings (lowercase keys) to correct display forms for VTT subtitles (e.g., `"kwen": "Qwen"`).
